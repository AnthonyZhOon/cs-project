...
const exampleTasks = [
  ...
  { name: 'Task 2', date: new Date(Date.now()+86400000), url: '#', complete: false },
  { name: 'Task 3', date: new Date(Date.now()+2*86400000), url: '#', complete: false },
];
  ...
  return (
    <div className="grid grid-cols-12 gap-4 p-6">
      ...
      <section className="col-span-12 lg:col-span-5 space-y-4">
        ...
        <ComponentBox title="Calendar">Calendar (placeholder)</ComponentBox>
      </section>
